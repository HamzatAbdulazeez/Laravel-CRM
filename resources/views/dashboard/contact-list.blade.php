                ...
                <div data-simplebar class="nicescroll-bar">
                    <div class="menu-content-wrap">
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            ...
                            <a href="#" class="btn btn-xs btn-icon btn-rounded btn-light" data-bs-toggle="modal"
                                data-bs-target="#add_new_label"><span class="icon" data-bs-toggle="tooltip"
                                    data-placement="top" title="" data-bs-original-title="Add Label"><span
                            ...
                            <ul class="nav nav-light navbar-nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link link-badge-right" href="#">
                                        ...
                                        <span
                                            class="badge badge-pill badge-sm badge-soft-primary ms-auto">2</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link link-badge-right" href="#">
                                        ...
                                        <span
                                            class="badge badge-pill badge-sm badge-soft-primary ms-auto">86</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link link-badge-right" href="#">
                                        ...
                                        <span
                                            class="badge badge-pill badge-sm badge-soft-primary ms-auto">34</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            ...
                            <a href="#" class="btn btn-xs btn-icon btn-rounded btn-light" data-bs-toggle="modal"
                                data-bs-target="#add_new_tag"><span class="icon" data-bs-toggle="tooltip"
                                    data-placement="top" title="" data-bs-original-title="Add Tag"><span
                                        class="feather-icon"><i data-feather="plus"></i></span></span></a>
                        </div>
                        <div class="tag-cloud">
                        ...
                        <ul class="nav nav-light">
                            <li class="nav-item nav-link">
                                <a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover"
                                    ...
                                    data-bs-original-title="Settings" href="#"><span class="icon"><span
                            ...
                            <li class="nav-item nav-link">
                                <a href="#" class="btn btn-icon btn-rounded btn-flush-dark flush-soft-hover"
                                    ...
                                    data-bs-original-title="Help"><span class="icon"><span
                                            class="feather-icon"><i data-feather="book"></i></span></span></a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="contactapp-detail-wrap">
                    <header class="contact-header">
                        <div class="d-flex align-items-center">
                            <div class="dropdown">
                                <a class="contactapp-title dropdown-toggle link-dark" data-bs-toggle="dropdown"
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="#"><span
                                            class="feather-icon dropdown-icon"><i
                                                data-feather="users"></i></span><span>All Contacts</span></a>
                                    <a class="dropdown-item" href="#"><span
                                            class="feather-icon dropdown-icon"><i
                                                data-feather="star"></i></span><span>Important</span></a>
                                    <a class="dropdown-item" href="#"><span
                                            class="feather-icon dropdown-icon"><i
                            ...
                            <div class="dropdown ms-3">
                                <button
                                    class="btn btn-sm btn-outline-secondary flex-shrink-0 dropdown-toggle d-lg-inline-block d-none"
                                    data-bs-toggle="dropdown">Create New</button>
                                <div class="dropdown-menu">
                        ...
                        <div class="contact-options-wrap">
                            <a class="btn btn-icon btn-flush-dark flush-soft-hover dropdown-toggle no-caret active"
                                href="#" data-bs-toggle="dropdown"><span class="icon"><span
                                        class="feather-icon"><i data-feather="list"></i></span></span></a>
                            <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item active" href="contact.html"><span
                                        class="feather-icon dropdown-icon"><i
                                            data-feather="list"></i></span><span>List View</span></a>
                                <a class="dropdown-item" href="contact-cards.html"><span
                                        class="feather-icon dropdown-icon"><i
                                            data-feather="grid"></i></span><span>Grid View</span></a>
                                <a class="dropdown-item" href="#"><span class="feather-icon dropdown-icon"><i
                                            data-feather="server"></i></span><span>Compact View</span></a>
                            </div>
                            <a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover no-caret d-sm-inline-block d-none"
                                href="#" data-bs-toggle="tooltip" data-placement="top" title=""
                                data-bs-original-title="Refresh"><span class="icon"><span
                            ...
                            <a class="btn btn-icon btn-flush-dark btn-rounded flush-soft-hover dropdown-toggle no-caret d-lg-inline-block d-none"
                                href="#" data-bs-toggle="dropdown"><span class="icon" data-bs-toggle="tooltip"
                                    data-placement="top" title="" data-bs-original-title="More"><span
                                        class="feather-icon"><i
                                            data-feather="more-vertical"></i></span></span></a>
                            <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item" href="profile.html"><span
                                        class="feather-icon dropdown-icon"><i
                                            data-feather="star"></i></span><span>Stared Contacts</span></a>
                                <a class="dropdown-item" href="#"><span class="feather-icon dropdown-icon"><i
                                            data-feather="archive"></i></span><span>Archive Contacts</span></a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="email.html"><span
                                        class="feather-icon dropdown-icon"><i
                                            ...
                                            <div class="col-xxl-2">
                                                <div class="form-group">
                                                    <button data-bs-toggle="collapse"
                                                        ...
                                                        class="btn btn-block btn-primary ">Create New
                                                    </button>
                                                </div>
                                                <div class="form-group">
                                ...
                                <table id="datable_1" class="table nowrap w-100 mb-5">
                                    ...
                                    <tbody>
                                        <tr>
                                                ...
                                                <div class="media align-items-center">
                                                    <div class="media-head me-2">
                                                        <div class="avatar avatar-xs avatar-rounded">
                                                            <img src="{{URL::asset('dist/img/avatar1.jpg')}}" alt="user"
                                                                class="avatar-img">
                                                        </div>
                                                    </div>
                                            ...
                                            <td>+145 52 5689</td>
                                            <td><span
                                                    class="badge badge-soft-violet my-1  me-2">Promotion</span><span
                                                    class="badge badge-soft-danger  my-1  me-2">Collaborator</span>
                                            </td>
                                            <td>Design</td>
                                            <td>13 Jan, 2020</td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <div class="dropdown-divider"></div>
                                                            <h6 class="dropdown-header dropdown-header-bold">
                                                                Change Labels</h6>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="media align-items-center">
                                                    <div class="media-head me-2">
                                                        <div class="avatar avatar-xs avatar-rounded">
                                                            <img src="{{URL::asset('dist/img/avatar9.jpg')}}" alt="user"
                                                                class="avatar-img">
                                                        </div>
                                                    </div>
                                                    <div class="media-body">
                                            ...
                                            <td>+234 48 2365</td>
                                            <td><span
                                                    class="badge badge-soft-danger my-1  me-2">Collaborator</span><span
                                                    class="badge badge-soft-success  my-1  me-2">Angular
                                                    Developer</span></td>
                                            <td>Developer</td>
                                            <td>13 Jan, 2020</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <span class="contact-star"><span class="feather-icon"><i
                                                                data-feather="star"></i></span></span>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="media align-items-center">
                                                    <div class="media-head me-2">
                                                        <div class="avatar avatar-xs avatar-rounded">
                                                            <img src="{{URL::asset('dist/img/avatar10.jpg')}}" alt="user"
                                                                class="avatar-img">
                                                        </div>
                                                    </div>
                                                    <div class="media-body">
                                            ...
                                            <td>+145 52 5463</td>
                                            <td><span
                                                    class="badge badge-soft-danger my-1  me-2">Promotion</span><span
                                                    class="badge badge-soft-light my-1  me-2">Advertisement</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="media align-items-center">
                                                    <div class="media-head me-2">
                                                        <div class="avatar avatar-xs avatar-rounded">
                                                            <img src="{{URL::asset('dist/img/avatar3.jpg')}}" alt="user"
                                                                class="avatar-img">
                                                        </div>
                                                    </div>
                                                    <div class="media-body">
                                                        <span class="d-block text-high-em">Jaquiline
                                                            Joker</span>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="media align-items-center">
                                                    <div class="media-head me-2">
                                                        <div class="avatar avatar-xs avatar-rounded">
                                                            <img src="{{URL::asset('dist/img/avatar7.jpg')}}" alt="user"
                                                                class="avatar-img">
                                                        </div>
                                                    </div>
                                                    <div class="media-body">
                                            ...
                                            <td><span
                                                    class="badge badge-soft-danger my-1  me-2">Collaborator</span><span
                                                    class="badge badge-soft-warning my-1  me-2">Angular
                                                    Developer</span></td>
                                            <td>Inventory</td>
                                            <td>24 Jun, 2019</td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="media align-items-center">
                                                    <div class="media-head me-2">
                                                        <div class="avatar avatar-xs avatar-rounded">
                                                            <img src="{{URL::asset('dist/img/avatar2.jpg')}}" alt="user"
                                                                class="avatar-img">
                                                        </div>
                                                    </div>
                                                    <div class="media-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="media align-items-center">
                                                    <div class="media-head me-2">
                                                        <div class="avatar avatar-xs avatar-rounded">
                                                            <img src="{{URL::asset('dist/img/avatar8.jpg')}}" alt="user"
                                                                class="avatar-img">
                                                        </div>
                                                    </div>
                                                    <div class="media-body">
                                                        <span class="d-block text-high-em">Katharine
                                                            Jones</span>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td>+741 56 7896</td>
                                            <td><span
                                                    class="badge badge-soft-violet my-1  me-2">Promotion</span>
                                            </td>
                                            <td>Inventory</td>
                                            <td>24 Jun, 2019</td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="media align-items-center">
                                                    <div class="media-head me-2">
                                                        <div class="avatar avatar-xs avatar-rounded">
                                                            <img src="{{URL::asset('dist/img/avatar13.jpg')}}" alt="user"
                                                                class="avatar-img">
                                                        </div>
                                                    </div>
                                                    <div class="media-body">
                                    ...
                                    <div class="row gx-3">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select id="input_tags_2" class="form-control"
                                                    multiple="multiple">
                                                </select>
